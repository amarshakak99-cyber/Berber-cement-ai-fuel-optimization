...
def get_background_style():
    """Get background style for the page - using gradient instead of images"""
    return {
...
def create_login_page():
    ...
    return html.Div([
        html.Div([
            html.Div([
                html.Span("🏭", style={'fontSize': '80px', 'display': 'block', 'textAlign': 'center', 'marginBottom': '20px'}),
...
if __name__ == '__main__':
    ...
    # For production (e.g., on PythonAnywhere or similar)
    # Use these settings:
